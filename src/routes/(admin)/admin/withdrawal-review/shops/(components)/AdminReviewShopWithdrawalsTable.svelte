<script lang="ts">
	...
	import { withdrawalStatusOptions, type AdminWithdrawal } from '$lib/types/Withdrawal';
	import { formatDateTime, formatVND, getTitleFromOptionList } from '$lib/utils/converters';
	import { DataTable } from '@careswitch/svelte-data-table';

	const { withdrawalsPromise }: { withdrawalsPromise: Promise<AdminWithdrawal[]> } = $props();
